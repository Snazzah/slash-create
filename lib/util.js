...
exports.validateOptions = exports.oneLine = exports.formatAllowedMentions = exports.verifyKey = void 0;
...
function validateOptions(options, prefix = 'options') {
    ...
    for (let i = 0; i < options.length; i++) {
        ...
        if (option.choices) {
            if (option.type === constants_1.CommandOptionType.SUB_COMMAND || option.type === constants_1.CommandOptionType.SUB_COMMAND_GROUP)
                throwError(Error, i, 'You cannot use the `choices` field in options that are sub-commands or sub-command groups!');
